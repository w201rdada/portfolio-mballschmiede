...
While financial marketplaces have been turned upside-down by artificial intelligence and automation over the course of the past decade, the secondary ticket marketplace has remained remarkably stagnant. As a result of this lack of innovation, one's options for buying or selling last minute event tickets remain to be exhausting, potentially fraudulent, and/or costly. ScalpPlaza seeks to provide users with  efficient, two-sided ticket marketplaces for any and all live entertainment events. Unlike most incumbent online ticket exchanges, ScalpPlaza will display both the best bid and offer price for any given ticket. This will allow users to buy or sell tickets in seconds when they’re in a rush or to try “cutting the market” in hopes of getting a better deal when they can afford to be patient. ScalpPlaza’s primary differentiating factor, however, is its ability and willingness to provide market liquidity by transacting with its users and accumulating ticket positions. This will be made possible through the use of a data-driven algorithmic ticket-pricing model. Essentially, ScalpPlaza aims to utilize historical data, market trends, and machine-learning in order to best predict what a ticket is worth on the open market based on the event’s original ticket price and a multitude of other pertinent intrinsic (performer(s), location, venue, date, social media #buzz, etc) and extrinsic (expected weather, other happenings in the area, etc) factors. The model will eventually use this estimated ticket value and a variance metric to generate prices at which ScalpPlaza would be comfortable buying or selling any given ticket. These prices will then drift dynamically based on informational changes, order flow, and ScalpPlaza’s internal ticket inventory. This second revenue stream will allow ScalpPlaza to charge signicantly lower fees than the exorbitant 20% (10% buyer + 10% seller) charged by some of its competitors. 
